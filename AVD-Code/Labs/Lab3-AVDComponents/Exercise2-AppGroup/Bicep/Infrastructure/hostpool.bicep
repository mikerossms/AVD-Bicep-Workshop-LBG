...
/*TASK*/
//Have a go at actually building the Application GRoup from scratch using the reference information below.
//Call the resource appGroup
//you will need hostPoolArmPath and aplicationGroupType as the least
//as with all reasource you should also have name, location and tags
//Reference: https://learn.microsoft.com/en-gb/azure/templates/microsoft.desktopvirtualization/applicationgroups?pivots=deployment-language-bicep
...
//The resource should be called appGroup and the name should reference the correct parameter/variable
...
/*TASK*/
//Add the diagnostic resource for the app group
