...
/*TASK*/
//Build the workspace resource named workspace
//As always it should have a name, location and tags
//It requires applicationGroupReference
...
/*TASK*/
//Add diagnostics for the workspace
