...
/*TASK*/
//Configure a name for the keyvault
//Format should be standard with other resources and start with "kv"
...
/*Task - call the Keyvault module*/
//Look at the existing keyvault.bicep to understand which parameters are required
//Use the "module" function to call the kevault module.
//HINT: It will look similar to the one for the network
